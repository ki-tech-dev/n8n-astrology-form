...
import { BackgroundEffects } from "../features/astrology/components/background-effects";
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="mb-8 animate-in fade-in slide-in-from-top duration-1000">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto mb-12">
                  Your personalized astrological chart reveals insights about
                  your personality, relationships, life purpose, and the cosmic
          ...
          <section className="py-20 px-4 bg-slate-900/20">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                  Getting your personalized birth chart is simple and takes just
                  a few minutes
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-16">
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-300">
                    Our advanced algorithms map the exact positions of planets
                    and celestial bodies at your birth moment.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-300">
                    Get your personalized birth chart and detailed
                    interpretation delivered directly to your inbox.
                  </p>
                </div>
              </div>
            </div>
